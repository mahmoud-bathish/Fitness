...
<head>
    ...
    <style>
        /* body{
            margin: 0;
            padding: 0;
            background: linear-gradient(100deg,#111715,#F78604 );
            height: 100vh;
            overflow: hidden;
        } */
        .containerr{
...
<header>
    <nav class="container">
        ...
        <div class="links">
            ...
            <button href="#portfolio" class="btn">Login</button>
        </div>
        <div class="hamburger">
            <div class="bar"></div>
            <div class="bar"></div>
...
<div class="parent" style='position:absolute;'>
    ...
    <div id="popupContainer" class="popup-container" style="display:none;justify-content:center;align-items:center;width:100%;z-index:10; height:100vh;background:white;position:absolute;">
        <div class="popup-content" style='background:red;width:50%;height:50%;'>
            <div style='height:10%;width:100%;text-align:end;padding-right:1%;'>
                <span class="close-btn" onclick="hidePopup()"style='cursor:pointer;font-size:24px;text-align:center;width:100%;'>&times;</span>
            </div>
            <div id="resultContainer" style="display:flex;align-items:center;justify-content:center;height:80%;width:100%;"></div>
        </div>
    </div>
</div>
